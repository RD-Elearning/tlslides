 ...
 * Uses generated metrics from Inter font for accurate width calculation.
 */
function charWidthForFamily(family: string): number {
  ...
  // Inter and other sans-serif families use the Inter average width from generated metrics.
  // Inter is the default font for tlslides and was loaded in the demo.
  return ADVANCE_WIDTH_TABLES.inter?.default ?? CUSTOM_FONT_AVG_CHAR_WIDTH_EM
}
...
const ADVANCE_WIDTH_TABLES: Record<string, { default: number; chars: Record<string, number> }> = {
   ...
   * extracted from Inter Regular (Google Fonts) at 1000 unitsPerEm.
   * Generated by tools/fonts/gen-metrics.js from the font binary.
   * These are the actual glyph advance widths for accurate text measurement.
   */
  inter: {
    default: 0.5385,
    chars: {
